...
* **CRM Integration (HubSpot & Salesforce):**
    * Connect HubSpot and Salesforce accounts via OAuth.
    * Search for contacts and view AI-suggested updates based on meeting transcripts.
    * Update CRM contact records directly from the meeting page.
    * **Ask Anything:** Chat interface to ask questions about contacts using @ mentions.
...
The "Ask Anything" feature allows users to ask questions about CRM contacts directly from the meeting page.

### How It Works

1. **Inline @ Mentions:** Type `@` followed by a contact name in the chat textarea
2. **Contact Search:** Search across both HubSpot and Salesforce contacts (depending on which CRMs are connected)
3. **AI-Powered Answers:** Questions are answered using:
   - CRM contact data (email, phone, company, etc.)
   - Meeting transcript context
4. **Sources:** Responses include source references (meeting recordings, etc.)

### Example Questions

- "What is 🗣️John Smith's email address?"
- "What did 🗣️Sarah mention about the timeline?"
- "Remind me what 🗣️Tim said about cost considerations"

### Technical Implementation

- **Component:** `lib/social_scribe_web/live/meeting_live/ask_anything_component.ex`
- **Features:**
  - Tab switching (Chat / History)
  - Chat history persistence within session
  - Collapsible interface
  - Auto-resize textarea
  - Inline contact mention with 🗣️ emoji
...
* **Contact Search:** Search for Salesforce contacts by name
* **AI Suggestions:** Generate suggested updates based on meeting transcript
* **Selective Updates:** Choose which fields to update before syncing
